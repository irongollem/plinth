...
export const LOOK_GROUPS: LookGroup[] = [
  ...
  },
  {
    ...
    knobs: [
      ...
      {
        path: "marmoset.color_saturation",
        label: "Material saturation ×",
        kind: "number",
        default: 1.04,
        min: 0,
        max: 2,
        step: 0.01,
        hint: "Expands resin chroma without changing its luminance",
      },
      {
        path: "marmoset.world_color",
        label: "Studio environment",
        kind: "color",
        default: [0.58, 0.6, 0.66],
