<template>
  <div class="flex flex-wrap items-center gap-2">
    ...
    <div class="flex basis-full items-center gap-2 lg:basis-auto">
      <select
        v-model="groupMode"
    ...
    <div class="flex basis-full items-center gap-2 xl:ml-auto xl:basis-auto">
      <div class="join">
        <div class="dropdown xl:dropdown-end">
          <button
            type="button"
            tabindex="0"
