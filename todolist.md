...
- [ ] Base cutter (design settled, see [docs/BASECUTTER.md](docs/BASECUTTER.md)): cut standard-base plugs out of designer landscape sculpts and seat them on parametric standard tapered wargaming plinths — a second embedded Blender script riding the existing render/provision pipeline, plus a 2D top-down placement UI; phase 1 spike shipped 2026-07-14 (`resources/base_cut.py`: hollow tapered plinth, magnet boss, seat-and-trim, all three cutter kinds manifold-verified and slicer-checked); remaining phase-1 exit: print one, press-fit a 5×1 magnet (taper settled at 15°/3.7mm from a caliper-measured 32mm round; slicer check passed 2026-07-14)
